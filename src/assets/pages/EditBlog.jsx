...
function EditBlog(){
    ...
    const editBlog=async(e)=>{
        e.preventDefault()
        const response=await axios.patch("https://mern3-node-vynn.onrender.com/blog/"+ id,data,{
            headers:{
        ...
        <div class="mx-14 mt-10 border-2 border-blue-400 rounded-lg">
                ...
                <form onSubmit={editBlog} >
                        <div class="p-8">
                                ...
                                <div class="">
                                <textarea name="description" id="description" cols="30" rows="10" class="mb-10 h-40 w-full resize-none rounded-md border border-slate-300 p-5 font-semibold text-black-300"  onChange={handleChange}  value={data.description}>Description</textarea>
                                </div>
