            ...
            <div class="mx-14 mt-10 border-2 border-blue-400 rounded-lg">
                ...
                <form onSubmit={createBlog} >
                        <div class="p-8">
                                ...
                                <div class="">
                                <textarea name="description" id="description" cols="30" rows="10" class="mb-10 h-40 w-full resize-none rounded-md border border-slate-300 p-5 font-semibold text-gray-300" onChange={handleChange} >Description</textarea>
                                </div>
